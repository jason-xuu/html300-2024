  ...
  <div class="container-fluid vh-100 d-flex flex-column">
    ...
    <main class="flex-grow-1 p-3">
      <div v-if="images.length" class="row">
        <div class="col-md-4" v-for="image in images" :key="image.src">
...
export default {
  data() {
    return {
      ...
      images: [
        { src: require('@/assets/image1.png'), alt: 'Responsive image 1' },
        { src: require('@/assets/image2.png'), alt: 'Responsive image 2' },
        { src: require('@/assets/image3.jpg'), alt: 'Responsive image 3' }
      ]
    };
  }
};
